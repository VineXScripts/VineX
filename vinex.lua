...
getgenv().VineXsilent = {
    ...
    FovSettings = {
        ...
        FovThickness = 1.5,
        FovTransparency = 0.7,
        FovColor = Color3.fromRGB(155, 155, 155),
        Filled = false,
...
local function toggleFeature()
    ...
    local status = getgenv().SharpSSilent.Enabled and "Vine Enabled" or "Vine Disabled"
    sendNotification("VineX Silent", status, "rbxassetid://17561420493")
...
sendNotification("dc.gg/sharpcc", "#1 Silent aim", "rbxassetid://17561420493")
wait(3)
sendNotification("dc.gg/sharpcc", "Supports Solara!", "rbxassetid://17561420493")
--[[ 

DO NOT SKID !! Source Made By @._core_. & @@peterbot_rr on Discord,
